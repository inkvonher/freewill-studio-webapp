...
export const GENERAL_LABELS = Object.fromEntries(GENERAL.map((q) => [q.key, q.label]));
...
export const questionRows = (brief) => {
  const d = brief.data || {};
  return [
...
export const briefToMarkdown = (brief) => {
...
export const budgetCopy = (budget) => {
...
export const getProposalData = (brief) => {
  const d = brief.data || {};
...
export const proposalToMarkdown = (brief) => {
...
export const proposalToHtml = (brief) => {
  const p = getProposalData(brief);
...
export const recommendedStack = (type) => {
...
export const projectPlanToMarkdown = (brief) => {
  const p = getProposalData(brief);
...
export const copyDraftToMarkdown = (brief) => {
  const p = getProposalData(brief);
...
export const technicalBriefToMarkdown = (brief) => {
  const p = getProposalData(brief);
  const stack = recommendedStack(p.type);
  return [
...
export const readmeToMarkdown = (brief) => {
  const p = getProposalData(brief);
  return [
    `# ${p.projectName}`,
    '',
...
export const agentPromptToMarkdown = (brief) => {
  const p = getProposalData(brief);
...
export const flattenBrief = (brief) => {
  const d = brief.data || {};
  const base = {
    id: brief.id,
...
export const downloadBriefMarkdown = (brief) => {
...
export const downloadClientKit = async (brief) => {
  const zip = new JSZip();
...
export const downloadBriefsCsv = (rows) => {
