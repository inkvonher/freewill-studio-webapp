  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        ['¿Incluye dominio y hosting?', 'Te asesoramos para conseguir tu dominio y publicar el sitio. El hosting puede ser gratuito o de bajo costo según el tipo de proyecto.'],
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Does it include domain and hosting?', 'We guide you to get your domain and publish the site. Hosting can be free or low-cost depending on the type of project.'],
