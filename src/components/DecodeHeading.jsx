...
// Cada palabra es una unidad indivisible (nunca se parte a la mitad); solo salta
// de línea entre palabras. goldWord queda en dorado. Respeta reduced-motion.
export default function DecodeHeading({ text, goldWord, as = 'h1', className = '', frameMs = 34, perChar = 0.55 }) {
  ...
  }, [text, goldWord, reduce, frameMs, perChar]);
